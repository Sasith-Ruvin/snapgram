  ...
  return (
    <Form {...form}>
      <div className="sm:w-420 flex-center flex-col">
        ...
        />
          <Button type="submit" className="shad-button_primary">{isCreatingAccount || isSigningIn || isUserLoading ?(
            <div className="flex-center gap-2">
              <Loader/>
            </div>
          ): "Sign up"}</Button>

          <p className="text-small-regualr text-light-2 text-center mt-2">Already Have an Account?
